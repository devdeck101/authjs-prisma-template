...
import { CodeIcon, ComputerIcon, LayersIcon, LayoutGridIcon, PaletteIcon, SmartphoneIcon, TabletIcon } from "lucide-react";
        ...
        <div className="flex-1 overflow-auto">
            <div className="grid h-full w-full grid-cols-[1fr_260px] gap-4">
                <div className="flex flex-col gap-1 rounded-lg border bg-muted/40">
                    ...
                    <div className="flex flex-1 border bg-background">
                        <Canvas />
                    </div>
